...
-- Date        : Mon Jun 26 13:48:29 2023
-- Host        : 612-28 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top cpuclk -prefix
--               cpuclk_ cpu_clk_sim_netlist.vhdl
-- Design      : cpu_clk
...
entity cpuclk_cpu_clk_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    locked : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end cpuclk_cpu_clk_clk_wiz;

architecture STRUCTURE of cpuclk_cpu_clk_clk_wiz is
...
begin
inst: entity work.cpuclk_cpu_clk_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked
